...
//const int nPoints7TeV = 27;
//int masses7TeV[nPoints7TeV]   = {120,/*125,*/130,140,150,160,170,180,200,210,220,250,300,325,350,400,425,450,475,525,550,575,600,650,700,750,/*800,*/900,950}; //FIXME: weights for 125 are wrong. There's a problem with 4mu efficiency for 800. 850 and 1000 are missing for the moment.
//double mHVal7TeV[nPoints7TeV] = {120,/*125,*/130,140,150,160,170,180,200,210,220,250,300,325,350,400,425,450,475,525,550,575,600,650,700,750,/*800,*/900,950};
