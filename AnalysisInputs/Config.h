...
//--------------------
// The number and values of mass points for which you have the trees, for 7 and 8 TeV
//const int nPoints7TeV = 29;
//int masses7TeV[nPoints7TeV]   = {120,125,130,140,150,160,170,180,200,210,220,250,300,325,350,400,425,450,475,525,550,575,600,650,700,750,800,900,950}; //FIXME
//double mHVal7TeV[nPoints7TeV] = {120,125,130,140,150,160,170,180,200,210,220,250,300,325,350,400,425,450,475,525,550,575,600,650,700,750,800,900,950}; //FIXME
//
